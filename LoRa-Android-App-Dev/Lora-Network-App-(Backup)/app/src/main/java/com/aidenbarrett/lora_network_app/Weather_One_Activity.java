...
public class Weather_One_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_weather__one_);

//        ActionBar actionBar = getActionBar();
//        actionBar.setDisplayHomeAsUpEnabled(true);

        //Setup dialogue
        Dialog = new ProgressDialog(Weather_One_Activity.this);
        Dialog.setMessage("Getting Dublin Weather...");
