 ...
 *  On receipt, transmits the values of SensorValue1, SensorValue2.
 *  Sensor1 = DS18B20
 *  Sensor2 = DS1620
*/
...
String str, res, toSTDB, sampleStr="4d304d304d304d304d304d30";
...
void loop() {  
  ...
  s2Val=readSensor2();
  sampleStr="";
  Serial.println("Sending to MASTER "+String(s0Val)+"oC"+":"+String(s1Val)+"oC"+":");
  
  //Preparing the Data String as 'value1:value2:value3: etc'
  //Then converting it to HEX also to get the HEX Data String which will be transmitted i.e. 43:22:56:
